...
local settingsTable = {
	General = {
		...
		rayfieldOpen = {Type = 'bind', Value = 'K', Name = 'Xploit Keybind'},
		-- buildwarnings
		-- rayfieldprompts
...
local Rayfield = useStudio and script.Parent:FindFirstChild('Rayfield') or game:GetObjects("rbxassetid://84701656902538")[1]
...
repeat
	...
	toDestroy, Rayfield = Rayfield, useStudio and script.Parent:FindFirstChild('Rayfield') or game:GetObjects("rbxassetid://84701656902538")[1]
...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping 'Show Xploit'.", Duration = 7, Image = 4400697855})
		else
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Xploit"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "Xploit"

	if Settings.LoadingTitle ~= "Xploit" then
		LoadingFrame.Version.Text = "Xploit UI"
	end
...
if useStudio then
	...
	local Tab2 = Window:CreateTab("Tab Example 2", 120764570997636) -- Title, Image
	...
	--RayfieldLibrary:Notify({Title = "Rayfield Interface", Content = "Welcome to Rayfield. These - are the brand new notification design for Rayfield, with custom sizing and Rayfield calculated wait times.", Image = 120764570997636})
	...
	local Label2 = Tab:CreateLabel("Warning", 120764570997636, Color3.fromRGB(255, 159, 49),  true)
